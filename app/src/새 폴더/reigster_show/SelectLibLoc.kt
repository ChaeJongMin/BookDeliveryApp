...
class SelectLibLoc : AppCompatActivity(), OnMapReadyCallback,GoogleMap.OnMarkerClickListener {
    ...
    lateinit var my_location:LatLng
                    ...
                    .addOnSuccessListener { doc->
                        ...
                        for(index in doc) {
                            ...
                            db.collection("customers").document(savemapdoc)
                                .update(mapOf(
                                    "selectLib" to text_library.text.toString(),
                                    "xcnts" to my_location.latitude,
                                    "ydnts" to my_location.longitude
                                ))
                            //"selectLib", text_library.text.toString()

                        }
                        var maptolistintent= Intent(this, TabMenu::class.java)
    ...
    fun setLastLocation(lastLocation:Location){
        ...
        my_location=LatLng(lastLocation.latitude,lastLocation.longitude)
